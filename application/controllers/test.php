...
class Test extends CI_Controller {
    ...
    public function testsql () {
        //$sql = "select item.*, size.name as size_name , item_type.name as item_name from item join size on size.id = item.size_id join item_type on item_type.id = size.item_type_id where purchase_id = 483";
        $sql = "SELECT * FROM transferred_item WHERE item_id = 11795";
