...
class Migration extends CI_Controller {
    ...
    public function init() {
        $this->seed_auth();
        //and insert a showroom as Headoffice.
        $showrooms = array('name' => 'Headoffice' , 'location' => 'Hemayedpur');
        $this->db->insert('showroom' , $showrooms);
        print 'initialized';
    }
    ...
    public function seed_auth() {
        $sql = "INSERT INTO `groups` (`id`, `name`, `description`) VALUES(1,'admin','Administrator'),(2,'members','General User')";
        $this->db->query($sql);
