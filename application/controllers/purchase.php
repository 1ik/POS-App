...
class Purchase extends CI_Controller {
    ...
    public function get_color_code($designer_style){
            ...
            $sql = "select color_code from item where designer_style = '".$designer_style."' order by item.id desc limit 1";
    ...
    public function delete($purchase_id) {
        ...
        if(!$this->purchase_model->has_transfer($purchase_id)) {

            $this->purchase_model->delete($purchase_id);
