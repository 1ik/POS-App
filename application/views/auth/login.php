    ...
    <div class="row">
        ...
        <div class="col-sm-4 col-sm-offset-4 well" id="login_holder">
            ...
            <?php echo form_open("auth/login" , array('role' => 'form'));?>
                ...
                <div class="form-group">
                    <a class="btn btn-default" style="margin-top : 10px" href="<?php echo site_url('assets/software.zip')?>"> Download Software </a>
                </div>
                <div class="form-group">
                    <a class="btn btn-default" href="<?php echo site_url('assets/7z922.exe')?>"> Download 7zip </a>
                </div>
