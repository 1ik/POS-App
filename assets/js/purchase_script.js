...
$(document).ready(function(){
    ...
    $("#purchase_add").click(function(){
        ...
        $.post('create_submit_json' ,{'val' : JSON.stringify(p)} , function(response){
            if(response == 'ok'){
...
//    var en = new entry(id,)
    ...
    $(html).prependTo('#purchase_table_body');

    //$(html).insertBefore('#purchase_table > tbody > tr:first');
    //$(html).prependTo('#purchase_table>tbody');
